  ...
  return (
    <section className={newsletterSectionClasses.container}>
      ...
      <p className={newsletterSectionClasses.subHeading}>
        Subscribe to Our Newsletter for Exclusive PC Updates, Offers, and Tips.
      </p>
...
const newsletterSectionClasses = {
  ...
  cardContainer:
    "rounded-2xl py-8 px-6 md:py-10 md:px-14 bg-[#11191a] mx-auto flex flex-col md:flex-row justify-between items-center",
  ...
  button:
    "bg-primary hover:bg-primary-dark text-white font-bold py-3 px-8 rounded-b-lg md:rounded-r-lg transition-all duration-200 md:ml-4 mt-4 md:mt-0",
};
