const mainHomeClassNames = {
  ...
  heading:
    "tracking-tight mb-3 text-primary font-bold text-xl md:text-2xl lg:text-3xl text-gray-900",
  paragraph:
  ...
  image:
    "max-h-fit w-full object-contain sm:h-72 md:h-96 lg:w-full lg:h-full rounded-2xl",
  ctaText:
    "text-white text-5xl md:text-5xl leading-[120%] md:leading-[155%] font-bold",
};

export default mainHomeClassNames;
